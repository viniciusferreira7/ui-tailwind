    ...
    <header className="fixed top-0 left-80 right-0 px-8 py-3 border-b border-white/10 backdrop-blur flex items-center justify-between">
      ...
      <div className="flex items-center">
        <nav className="text-sm flex items-center gap-6">
          <a
            className="text-zinc-400 hover:text-zinc-100 transition-colors ease-in-out"
            href=""
          >
            API
          </a>
        ...
        <div className="flex items-center border-l border-white/10 pl-6 ml-6 gap-6">
          ...
          <button
            className="border border-cyan-800 bg-cyan-400/10 text-cyan-400 px-3 py-0.5 
          rounded-full text-sm font-medium hover:bg-cyan-300/30 hover:border-cyan-400 transition-colors"
          >
            Sign in
          </button>
        </div>
